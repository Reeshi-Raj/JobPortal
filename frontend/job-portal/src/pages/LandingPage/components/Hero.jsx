...
const Hero = () => {
    ...
    const user= {fullNme:"Reeshi Raj", role:"employer"};
        ...
        <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <motion.h1
                    ...
                    className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight pt-2"
                    >
                ...
                >
                    ...
                    Your nextcareer move or perfect candidate is just one click away.
                </motion.p>
                {/* CTA Buttons*/}
                <motion.div
                    initial={{opacity: 0, y:30}}
                ...
                >
                    <motion.button
                        ...
                        className="group bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-xl hover:from-blue-700 hover:to-purple-700 transition-colors font-semibold transition-all duration-300 shdow-lg hover:shadow-xl flex items-center space-x-2"
                    >
                    ...
                    <motion.button
                        whileHover={{scale: 1.02}}
                        whileTap={{scale: 0.98}}
                        className="bg-white border-2 border-gray-200 text-gray-700 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-300 hover:bg-gray-50 transition-all duration-300 shadow-sm hover:shadow-md"
